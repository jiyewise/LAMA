...
namespace GUI
{
	void drawSkeleton(const dart::dynamics::SkeletonPtr& _skel, int _type=0, bool _drawMeshColor=true);
	void drawSkeleton(const dart::dynamics::SkeletonPtr& _skel, std::map<std::string, Eigen::Vector4d> _colorMap, int _type=0);
	...
	void drawShape(Eigen::Isometry3d _T,
		...
		Eigen::Vector4d _color, bool _drawMeshColor=true);
